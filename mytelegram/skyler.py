...
skyler_json_path = join(dirname(__file__), 'skyler.json')

logging.basicConfig(filename='skyler.log', level=logging.FATAL)
...
class Skyler:
    def __init__(self, jsonpath=None):
        self.init_file = jsonpath or skyler_json_path
...
if __name__ == '__main__':
    skyler = Skyler(skyler_json_path)
